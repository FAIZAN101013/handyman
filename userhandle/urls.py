...
urlpatterns = [
    ...
    path('profile/services/add/', views.AddServiceOffering, name='add-service-offering'),
    path('profile/services/<int:id>/delete/', views.DeleteServiceOffering, name='delete-service-offering'),
